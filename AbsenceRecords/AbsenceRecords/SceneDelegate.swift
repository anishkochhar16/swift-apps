...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func getHomeViewController() -> HomeViewController? {
        ...
        let absenceNavigationController = tabViewController?.children.first
        let homeViewController = absenceNavigationController?.children.first as? HomeViewController
